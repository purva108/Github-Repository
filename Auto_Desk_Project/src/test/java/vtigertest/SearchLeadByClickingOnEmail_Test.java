...
public class SearchLeadByClickingOnEmail_Test extends BaseClass
{
	...
	public void creatLead() throws Throwable
	{
		...
		createleadpage.LeadSaveMethod();
		 ...
		 searchpage.getSearchbarTF().sendKeys("purvagupta.pr108@gmail.com");
		         wUtil.SelectOption(searchpage.getSearcharDropdown(), "Email");
